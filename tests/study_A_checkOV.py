...
"""predict on trained samples, to see overtrain ot not!"""
...
def main (args):
    ...
    # Load data
    data, features, _ = load_data(args.input + 'data.h5', train=True,debug=args.debug) #should fillna for test input
